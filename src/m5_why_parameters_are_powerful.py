...
def main():
    ...
    # better_draw_circles(rg.Point(1, 2), 30)
    # better_draw_circles(rg.Point(15, 16), 15)
    #even_better_draw_circles(rg.Point(20,30), 30, 30, 'green', 3)
    #even_better_draw_circles(rg.Point(-15,15), 16, 40, 'red', 5)

    draw_circles(rg.Point(38, 69))
    draw_circles(rg.Point(-343, 232))
    better_draw_circles(rg.Point(23, -43), 65)
    better_draw_circles(rg.Point(22, 60), 43)
    even_better_draw_circles(rg.Point(-10,-30), 20, 30, 'light blue', 14)
    even_better_draw_circles(rg.Point(33,-23), 30, 40, 'red', 8)
